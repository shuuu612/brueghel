        ...
        <div v-for="(files, index) in getSettingFiles" :key="index" class="content">
          ...
          <div class="boby-outer">
            ...
            <div v-for="(file, index2) in files" :key="index2 + 1000" class="setting-outer">
              ...
              :selected-index2="selectedIndex2"
              :open="isOpenMenu"
              :format="settingFiles[index][index2].settingFormat"
              :format-level="settingFiles[index][index2].settingFormatLevel"
              :original-width="settingFiles[index][index2].originalWidth"
              :original-height="settingFiles[index][index2].originalHeight"
              ...
              :original-format="settingFiles[index][index2].originalFormat"
