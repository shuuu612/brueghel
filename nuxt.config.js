export default {
  ...
  head: {
    ...
    meta: [
      ...
      // OGP設定
      { hid: 'og:site_name', property: 'og:site_name', content: 'Brueghel' },
      { hid: 'og:type', property: 'og:type', content: 'website' },
      { hid: 'og:url', property: 'og:url', content: 'https://brueghel.shuuu.jp/' },
      { hid: 'og:title', property: 'og:title', content: 'Brueghel | 画像変換ツール' },
      { hid: 'og:description', property: 'og:description', content: 'Web制作者向けの画像変換サイトです。WebPへの変換にも対応しております。' },
      { hid: 'og:image', property: 'og:image', content: 'https://brueghel.shuuu.jp/ogp.png' },
